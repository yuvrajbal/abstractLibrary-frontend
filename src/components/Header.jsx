...
export default function Header(){
  ...
  return (
    <div className="flex flex-row justify-between dark:bg-neutral-800 px-4 rounded-3xl mb-10 mx-8 py-2">
        ...
        <div className="flex items-center gap-1 sm:gap-3 ">
          <button 
            ...
            {darkMode? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" class="size-8">
          ...
          {!loading && (isSignedIn ? (
            <button 
            className="px-3 text-lg py-1  rounded-lg hover:bg-neutral-300 font-medium dark:text-white dark:hover:bg-neutral-600"
            onClick={signOut}
            >
